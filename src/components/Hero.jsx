...
const Hero = () => {
  ...
  return (
    <>
      <div className="pt-4">
        <div className="flex md:flex-wrap justify-around flex-wrap-reverse">
          <motion.div className="-z-10" {...slideAnimation("right")}>
          ...
          <motion.div className="flex flex-col justify-start items-start">
            {heading.map((item) => (
              <>
                <motion.h1 key={item.id} className="text-white  font-light">
      ...
      <motion.div
        ...
        initial="initial"
        whileInView="animate"
        className="pt-5 md:pb-24 pb-10 mt-5 md:mt-0"
      >
        <motion.p className="text-white font-poppins md:text-[62px] text-[28px] font-light md:leading-[8rem] leading-[3rem]">
      ...
      <div className="pt-10 pb-10 md:pt-24 md:pb-24">
        ...
        >
          <div className="text-white font-poppins font-light text-[20px] md:text-[40px] flex-auto w-[40rem] md:leading-[4rem] py-5 sm:py-0">
            <p>
